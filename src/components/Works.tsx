          ...
          >
            {works.map((work, idx) => (
              <article
                ...
                aria-labelledby={`work-card-title-${work.id}`}
                ref={(el) => {
              ...
              >
                ...
                <div className="works-preview__data">
                  ...
                  <div className="works-preview__row">
                    ...
                    <span
                      className="works-preview__val works-preview__val--title"
                      id={`work-card-title-${work.id}`}
                    >
                ...
                <div className="works-preview__footer">
                  ...
                  <button
                    type="button"
                    className="works-preview__action"
        ...
        works.map((work, idx) => (
          ...
          >
            ...
            <div className="works-preview__data">
              ...
              <div className="works-preview__row">
                <span className="works-preview__key">NAME</span>
                <span className="works-preview__val works-preview__val--title">{renderText(work.title)}</span>
              </div>
              <div className="works-preview__row">
                <span className="works-preview__key">TECH</span>
                <span className="works-preview__val">{work.stack}</span>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="constellation-node__point" />
                  </button>
                </div>
              )
            })}
                  ...
                  {activeWork.img.length > 0 ? (
                    activeWork.img.map((img, idx) => (
                      <WorkDetailImage
                        ...
                        src={img}
                        index={idx}
                        alt={`${activeWork.title} — ${String(idx + 1).padStart(2, '0')}`}
                      />
                    ))
                  ) : (
