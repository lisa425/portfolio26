 ...
 */
function WorksPreviewCard({ work, index, total, active = false, onClick, ref }: WorksPreviewCardProps) {
  return (
    ...
    <div
      ...
      aria-label={onClick ? `Open ${work.title} project details` : undefined}
      ref={ref}
    >
      ...
      <div className={styles['works-preview__data']}>
        ...
        <div className={styles['works-preview__row']}>
          ...
          <span className={styles['works-preview__val']}>{renderText(work.title)}</span>
        </div>
        <div className={styles['works-preview__row']}>
