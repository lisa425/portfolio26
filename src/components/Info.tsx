    ...
    <>
      ...
      <nav className="terminal-bar info-nav">
        ...
        <span className="terminal-bar__bar">
          ...
          {SECTIONS.map((s) =>
            activeSection === s.id ||
            SECTIONS.findIndex((sec) => sec.id === activeSection) >=
              SECTIONS.findIndex((sec) => sec.id === s.id)
              ? "█"
              : "░",
          ).join("")}
          ]
      ...
      >
        <div ref={contentRef} style={{ width: "100%", position: "relative" }}>
          {/* SVG Lines overlay */}
          <svg ref={svgRef} className="info-lines" width="100%" height="100%">
          ...
          <div className="info-content-scroll">
            ...
            >
              ...
              <div className="info-section__body">
                ...
                <div className="info-section__content">
                  ...
                  <h2
                    className={`info-name ${i18n.language === "ko" ? "text-display" : "text-body"}`}
                  >
                    {t("info.name")}
                  </h2>
              ...
              <div className="info-section__body">
                ...
                <div className="info-section__content">
                  ...
                  {workExperience.jobs.map((job: any, jIdx: number) => (
                    <div key={jIdx} className="job-entry">
                      ...
                      <div className="job-entry__projects">
                        {job.projects.map((proj: any, pIdx: number) => (
                          <div key={pIdx} className="project-entry text-body">
            ...
            <section className="info-section__footer">
              © 2026 ChaeWon Im. All rights reserved.
            </section>
          </div>
        </div>
      </div>
