    ...
    const ctx = gsap.context(() => {
      const timer = setTimeout(() => {
        ...
        const revealElements = gsap.utils.toArray(
          ".info-name, .info-role, .info-about, .info-block-title, .info-in",
        );
      ...
      <div ref={contentRef} style={{ width: "100%", position: "relative" }}>
        ...
        <div className="info-content-scroll">
          ...
          <section id="profile" className="info-section">
            ...
            <p className="info-about">{t("info.about")}</p>
          </section>
          {/* 2. Experience */}
          <section id="experience" className="info-section">
            ...
            {workExperience.jobs.map((job: any, jIdx: number) => (
              <div key={jIdx} className="job-entry  info-in">
                ...
                {job.projects.map((proj: any, pIdx: number) => (
                  <div key={pIdx} className="project-entry">
                    <h5>■ {proj.name}</h5>
                    <ul>
          ...
          <section id="contact" className="info-section">
            ...
            <div className="info-contact info-in">
              <p className="btn-contact">📧 {contact.email}</p>
              <p className="btn-contact">📞 {contact.phone}</p>
            </div>
          </section>
